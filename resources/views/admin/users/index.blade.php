                                ...
                                <td class="table-plus">
                                    <div class="name-avatar d-flex align-items-center">
                                        <div class="avatar mr-2 flex-shrink-0">
                                                @if($user->detail_users)
                                                <img
                                                    src="{{asset('storage/'.$user->detail_users()->first()->photo)}}" class="border-radius-100 shadow" width="40" height="40" alt="" />
                                                @else
                                                    {{-- <img src="{{ asset('path/ke/foto/default.jpg') }}" alt="Foto Profil Default"> --}}
                                                @endif
                                        </div>
                                        <div class="txt">
