...
<body>
    ...
    <div class="container">
        ...
        <p style="padding: 0 50px 0 50px">Yang bertanda tangan dibawah ini Kepala Desa Kedungringin Kecamatan Beji Kabupaten Pasuruan</p>
        <ol style="padding: 0 100px 0 100px">
            <li>Menerangkan bahwa :</li>
            <li>Nik : {{$user->detail_users->nik}}</li>
            <li>Alamat : {{$user->detail_users->address}}</li>
            <li>name : {{$user->name}}</li>
            <li>jk : {{$user->detail_users->gender}}</li>
            <li>ttl : {{$user->detail_users->born_place .', '. $user->detail_users->born_date}}</li>
        </ol>

        <p style="padding: 0 50px 0 50px">Bahwa lembaga tersebut diatas benar - benar  berdomisili di Dusun Kedungringin Utara RT 14 RW 04 Desa Kedungringin Kecamatan Beji Kabupaten Pasuruan.Surat Keterangan ini dibuat untuk persyaratan Permohonan Bantuan.
...
<div class="ttd">
    <div class="ttd-kiri" style="text-align: center">
        ...
        <p style="margin-bottom: 5px;">Kepala Desa Kedungringin</p>
        <br>
        <br>
        <br>
