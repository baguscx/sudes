                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="role" class="custom-select form-control">
                                        ...
                                        <option {{ $user->roles->pluck('name')->implode(', ') == 'staff' ? 'selected' : '' }} value="staff">Staff</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="address" class="form-control">
                                            ...
                                            <option {{$user->detail_users->address  == 'Gersikan' ? 'selected' : ''}} value="Gersikan">Gersikan</option>
                                            <option {{$user->detail_users->address  == 'Ngayunan Barat' ? 'selected' : ''}} value="Ngayunan Barat">Ngayunan Barat</option>
                                            <option {{$user->detail_users->address  == 'Ngayunan Timur' ? 'selected' : ''}} value="Ngayunan Timur">Ngayunan Timur</option>
                                            <option {{$user->detail_users->address  == 'Kedungringin Utara' ? 'selected' : ''}} value="Kedungringin Utara">Kedungringin Utara</option>
                                            <option {{$user->detail_users->address  == 'Kedungringin Tengah' ? 'selected' : ''}} value="Kedungringin Tengah">Kedungringin Tengah</option>
                                            <option {{$user->detail_users->address  == 'Kedungringin Selatan' ? 'selected' : ''}} value="Kedungringin Selatan">Kedungringin Selatan</option>
                                            <option {{$user->detail_users->address  == 'Guyangan' ? 'selected' : ''}} value="Guyangan">Guyangan</option>
                                            <option {{$user->detail_users->address  == 'Bahrowo' ? 'selected' : ''}} value="Bahrowo">Bahrowo</option>
                                            <option {{$user->detail_users->address  == 'Balungrejo' ? 'selected' : ''}} value="Balungrejo">Balungrejo</option>
                                            <option {{$user->detail_users->address  == 'Ngampel' ? 'selected' : ''}} value="Ngampel">Ngampel</option>
                                        </select>
